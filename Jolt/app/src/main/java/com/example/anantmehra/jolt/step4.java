...
public class step4 extends AppCompatActivity {
    ...
    public static final Integer REQUEST_CAMERA = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button step4=(Button)findViewById(R.id.button6);
        upload_image = (ImageView) findViewById(R.id.imageaadhar);
        Button uploadd = (Button) findViewById(R.id.uploadd);
